...
public enum ErrorCode implements IError {
    ...
    SCHEDULER_CONFIG_ALREADY_EXISTS(1224),
    SCHEDULER_CONFIG_NOT_FOUND(1225),
    SCHEDULER_GROUP_NOT_FOUND(1226),
    SCHEDULER_CONFIG_IS_ENABLED(1227),
    SCHEDULER_CONFIG_NAME_INVALID(1228),
