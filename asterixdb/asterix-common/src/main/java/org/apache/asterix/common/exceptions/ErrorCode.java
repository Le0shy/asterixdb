...
public enum ErrorCode implements IError {
    ...
    SCHEDULER_CONFIG_ALREADY_EXISTS(1200),
    SCHEDULER_CONFIG_NOT_FOUND(1201),
    SCHEDULER_GROUP_NOT_FOUND(1202),
    SCHEDULER_CONFIG_IS_ENABLED(1203),
    SCHEDULER_CONFIG_NAME_INVALID(1204),
