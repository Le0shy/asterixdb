...
public class KMeansReclusterOperatorTest {
    // The seed the desugar passes when a query gives none. The expected picks below are the ones this seed
    // produces, so every fixture here must be built with it.
