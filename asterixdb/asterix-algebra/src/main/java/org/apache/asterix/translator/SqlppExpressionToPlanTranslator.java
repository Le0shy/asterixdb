...
public class SqlppExpressionToPlanTranslator extends LangExpressionToPlanTranslator
    ...
    public Pair<ILogicalOperator, LogicalVariable> visit(ClusterbyClause clusterbyClause,
        ...
        // Only a radius the query reads exists on the operator; see ClusterByOperator.isRadiusRead().
        LogicalVariable radiusVar =
                clusterbyClause.isRadiusRead() ? context.newVarFromExpression(clusterbyClause.getRadiusVar()) : null;
