 ...
 * in-memory sorts).
 * <p>
 * One input: the vectors to cluster. Seeding is part of the algorithm, so the physical operator does it --
 * an initial-centroid input would make the seeding strategy the language's business rather than the
 * strategy's.
 */
